...
lyr_OSMStandard_0.setVisible(true);lyr_FusionIRIS_1.setVisible(true);lyr_MasqueOSM_2.setVisible(true);lyr_masqueIRIS_3.setVisible(true);lyr_StationsPM10ATMO_4.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_FusionIRIS_1,lyr_MasqueOSM_2,lyr_masqueIRIS_3,lyr_StationsPM10ATMO_4];
...
lyr_StationsPM10ATMO_4.on('precompose', function(evt) {
